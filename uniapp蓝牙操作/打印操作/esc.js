...
var jpPrinter = {　　　　
  ...
  Query: function() {
    ...
    queryStatus.query = function(buf) {
		...
		console.log( store.state.writeServiceId)
		console.log( store.state.writeCharaterId)
		console.log(buf)
      uni.writeBLECharacteristicValue({
        deviceId: store.state.deviceId,
        serviceId: store.state.writeServiceId,
        characteristicId: store.state.writeCharaterId,
        value: buf,
